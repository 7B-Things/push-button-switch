...
def build_switch_bottom():
    ...
    switch_bottom=switch_bottom.hole(2.4,depth=None,clean=True)
    switch_bottom=switch_bottom.faces("|Z").faces(">Z").workplane(offset=0.0,invert=True,centerOption="CenterOfBoundBox")
    switch_bottom=switch_bottom.polarArray(switch_diameter / 2.0 - 3.0,startAngle=45,angle=360.0,count=3,fill=True,rotate=True)
    switch_bottom=switch_bottom.rect(3.2,3.2,centered=True,forConstruction=False)
    switch_bottom=switch_bottom.cutBlind(1.2,clean=True,taper=0.0)

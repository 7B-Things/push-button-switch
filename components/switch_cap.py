...
cap_depth=12.0 # {"data_type":"number","comment":""}
# end_params
def build_switch_cap():
    ...
    switch_cap=switch_cap.circle(switch_diameter / 2.0 + 4.0,forConstruction=False)
    ...
    switch_cap=switch_cap.circle(switch_diameter / 2.0 + 1.0,forConstruction=False)
    ...
    switch_cap=switch_cap.circle(switch_diameter / 2.0 - 10.0,forConstruction=False)
    switch_cap=switch_cap.circle(switch_diameter / 2.0 - 5.0,forConstruction=False)
    switch_cap=switch_cap.extrude(5.5,combine=True,clean=True,both=False,taper=0.0)
    return switch_cap
